...
package "gdistcc"
purpose "The Ganglia DistCC Client (gdistcc) connects with a 
Ganglia Monitoring Daemon (gmond) and runs distcc against a
load-balanced list of hosts"

option "debug" d "Print debugging information" flag off
option "verbose" v "Run distcc in verbose mode" flag off
option "executable" x "The distcc executable to run" string default="distcc" no
option "seconds" s "The number of seconds to cache" int default="10" no
